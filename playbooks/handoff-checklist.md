...
- [ ] Re-eval triggers written down: model version changes, prompt/agent changes, [cadence]. The owner knows a *capability upgrade* is also a trigger (the workflow may be able to do more now, not just still work)
