...
| [coverage: work now done that wasn't] | [n/a] | [value] | |
...
[3 to 5 lines: the workflow shape (e.g. classify, enrich, draft, human gate), where the human verification sits, what autonomy level, where it lives in their tools. Enough that another team could recognize whether the pattern fits them.]
...
- What would have to be true for this to work: [1 to 2 lines]
