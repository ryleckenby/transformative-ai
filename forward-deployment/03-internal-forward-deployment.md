...
- **2–3 FDE-profile engineers** (see [skill profile](01-the-fde-model.md)) — product-minded, full-stack-pragmatic, comfortable in other people's domains
...
- **A funnel and a queue**: teams request engagements; the FDE group qualifies hard and runs 1–2 concurrent engagements per FDE, max
...
**Where it reports.** Under a CTO/CIO it risks tool-first drift; under a COO/business unit it risks becoming one unit's private team. Either works *if* the charter is explicit: the team's product is *workflow wins across the org plus the platform they feed*, and its scorecard says so.
...
- **Q3:** 3–4 engagements, at least one reusing patterns from Q1–2 (time-to-value should visibly drop). First clean kill — publicize it too; it buys enormous credibility. First rotation begins.
