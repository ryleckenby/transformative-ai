...
- **Engagements too small to carry a human.** The motion's floor cost is real; below it, use champions plus patterns plus office hours (the lightweight end of [enablement](../enablement/02-adoption-playbook.md)) instead.
