...
- **Next step:** Pick 2–3 high-friction workflows in willing teams and go deep (Stage 2 tactics). Stop measuring seats; start measuring workflow outcomes.
...
4. **The transitions are people problems.** 0→1 is a permission problem. 1→2 is a skills-and-embedding problem. 2→3 is an infrastructure-and-incentives problem. 3→4 is an executive-courage problem.
